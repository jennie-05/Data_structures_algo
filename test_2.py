...
def test_complex_network_cheapest_route():
    ...
    flights = [
        ...
        Flight(0, 0, 0, 1, 120, 300),      # NY -> Chicago: expensive direct
        Flight(1, 0, 60, 1, 180, 250),     # NY -> Chicago: cheaper direct
        Flight(2, 0, 0, 3, 360, 800),      # NY -> LA: expensive direct
        Flight(3, 0, 0, 2, 180, 150),      # NY -> Denver: cheap flight
        Flight(11, 0, 30, 2, 210, 200),    # NY -> Denver: alternative route
        Flight(12, 0, 0, 4, 180, 400),     # NY -> Seattle: direct option
        Flight(18, 0, 80, 1, 190, 250),    # NY -> Chicago: medium cost
        
        # Connections through Chicago (1)
        Flight(4, 1, 140, 3, 300, 200),    # Chicago -> LA: medium cost
        Flight(5, 1, 200, 3, 360, 180),    # Chicago -> LA: cheaper option
        Flight(13, 1, 200, 4, 350, 250),   # Chicago -> Seattle: medium route
        Flight(14, 1, 210, 4, 360, 200),   # Chicago -> Seattle: cheaper route
        
        # Connections through Denver (2)
        Flight(6, 2, 200, 3, 380, 200),    # Denver -> LA: medium cost
        Flight(10, 2, 200, 3, 290, 100),   # Denver -> LA: cheapest option
        Flight(15, 2, 220, 4, 380, 150),   # Denver -> Seattle: good route
        
        # Seattle connections (4)
        Flight(16, 4, 200, 3, 360, 180),   # Seattle -> LA: medium route
        Flight(17, 4, 380, 3, 480, 300),   # Seattle -> LA: expensive route
        Flight(19, 4, 370, 2, 380, 200),   # Seattle -> Denver: medium route
        # Return flights
        Flight(7, 1, 400, 0, 520, 300),    # Chicago -> NY
        Flight(8, 3, 400, 0, 760, 800),    # LA -> NY
        
        # Late flights
        Flight(9, 0, 500, 3, 860, 700),   # NY -> LA: expensive late direct
    ]
    ...
    test_scenarios = [
        # Original test cases...
        {
            ...
            "expected_flight_numbers": [1],  # Should take cheaper direct flight
        ...
        },
        {
            ...
            "expected_flight_numbers": [18, 14, 17],
